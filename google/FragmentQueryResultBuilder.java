...
public class FragmentQueryResultBuilder extends QueryResultBuilder<TextFragment> {
    private final Logger logger = LoggerFactory.getLogger(getClass());
    private QueryUtil util = new QueryUtil();

    public FragmentQueryResultBuilder(GoogleMTParameters params, String name, int weight) {
        super(params, name, weight);
    }

    @Override
    public QueryResult createDummyResponse(TextFragment sourceContent) {
    ...
    @Override
    public List<QueryResult> convertResponses(List<TranslationResponse> responses, TextFragment frag) {

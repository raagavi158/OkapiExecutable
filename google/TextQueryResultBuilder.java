...
public class TextQueryResultBuilder extends QueryResultBuilder<String> {
    public TextQueryResultBuilder(GoogleMTParameters params, String name, int weight) {
        super(params, name, weight);
    }

    @Override
    public List<QueryResult> convertResponses(List<TranslationResponse> responses, String text) {
    ...
    @Override
    public QueryResult createDummyResponse(String sourceContent) {
